...
scripts/prepare-data.py ${data_dir}/train.raw fr en ${data_dir} --lowercase --no-tokenize en \
 --dev-corpus ${raw_data}/dev --test-corpus ${raw_data}/test --normalize-punk fr --shuffle --seed 1234 --vocab-size 30000
...
scripts/prepare-data.py ${raw_data}/train fr en ${data_dir} --mode vocab --character-level --vocab-prefix vocab.char \
--vocab-size 200
