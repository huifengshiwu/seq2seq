...
for i in {1..20}; do
    cat ${raw_data}/{train,train.2017}.mt >> ${data_dir}/train.raw.mt
    cat ${raw_data}/{train,train.2017}.pe >> ${data_dir}/train.raw.pe
    cat ${raw_data}/{train,train.2017}.src >> ${data_dir}/train.raw.src
done
