...
printf "Greedy dev:            " ./seq2seq.sh ${model_dir}/config.yaml --eval dev --beam-size 1 | tail -n1
printf "Greedy test:           " ./seq2seq.sh ${model_dir}/config.yaml --eval test --beam-size 1 | tail -n1
printf "Beam 5 dev:            " ./seq2seq.sh ${model_dir}/config.yaml --eval dev --beam-size 5 | tail -n1
printf "Beam 5 test:           " ./seq2seq.sh ${model_dir}/config.yaml --eval test --beam-size 5 | tail -n1
