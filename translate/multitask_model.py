...
class MultiTaskModel:
    ...
    def decode(self, *args, **kwargs):
        return self.main_model.decode(*args, **kwargs)

    def evaluate(self, *args, **kwargs):
        return self.main_model.evaluate(*args, **kwargs)

    def align(self, *args, **kwargs):
        return self.main_model.align(*args, **kwargs)

    def initialize(self, *args, **kwargs):
        return self.main_model.initialize(*args, **kwargs)

    def save(self, *args, **kwargs):
        return self.main_model.save(*args, **kwargs)
